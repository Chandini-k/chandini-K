...
namespace CaseStudy.Controllers
{
    public class ItemController : Controller
    {
        ...
        [HttpPost]
        public ActionResult ItemAdd(int id, int price, string item_name, string description, int stock_number, string remarks)
        {
        ...
        //        ViewBag.message = items.Item_Name + "has got successfully addes";
        //        return RedirectToAction("Login");
        //    }
        //    catch (Exception e)
        //    {
        //        ViewBag.message = items.Item_Name + "Failed ";
        //        return View();
        //    }
