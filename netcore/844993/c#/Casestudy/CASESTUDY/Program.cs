...
namespace CASESTUDY
{
    class Program
    {
        public static void Main(string[] args)
        {
            ...
            while (true)
            {
                Console.WriteLine("Are You Buyer/Seller or other\n*********Please  Enter b for Buyer and s for Seller *************");
                        ...
                        case 1:
                            ...
                            while (true)
                            {
                                while (true)
                                {
                                    ...
                                    {
                                        Console.WriteLine("the length should be greater than or equal to 8");
                                ...
                                re: Console.WriteLine("ReEnter password");
               ...
               else if (a == 's')
                {
                        ...
                        switch (ch)
                        {
                            ...
                            } while (true)
                            {
                                ...
                                if (ch3 == 1)
                                {
                                    Console.WriteLine("Enter no of items to add");
